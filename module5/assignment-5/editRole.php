                ...
                <div class="row">
                  <div class="col-md-12 mb-4">
                    <div class="form-outline">
                      <input type="hidden" name="id" value="<?php echo $id ?? ''; ?>" id="id" class="form-control form-control-lg" />
                      <label class="form-label" for="role">Role Name</label>
                      <input type="text" name="role" id="role" value="<?php echo $role ?? ''; ?>" class="form-control form-control-lg" />
                    </div>
                  </div>
                </div>
                <div class="mt-4 pt-2">
