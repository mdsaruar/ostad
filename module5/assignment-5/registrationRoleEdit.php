                ...
                <div class="row">
                  <div class="col-md-12 mb-4 pb-2">
                    <div class="form-outline">
                      ...
                      <input required type="email" name="emailAddress" id="emailAddress" value="<?php echo $emailAddressvalue; ?>" class="form-control" />
                    </div>
                  </div>
                  <div class="col-md-12 mb-4">
                    <div class="form-outline">
                      <label class="form-label" for="lastName">User Name</label>
                      <input required type="text" name="userName" id="userName" value="<?php echo $userNamevalue; ?>" class="form-control" />
                    </div>
                  </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                  <div class="col-12">
                    <div class="form-outline">
                      ...
                      <select class="select form-control form-select" name="role">
